          ...
          <View style={{height: DEVICE_HEIGHT}}>
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <View style={styles.inputView}>
                ...
                >
                  <TextBase title="Quên mật khẩu?" style={styles.forgot} />
                </TouchableOpacity>
                {/* </KeyboardAvoidingView> */}
              </View>
            </TouchableWithoutFeedback>
            <View style={styles.actionView}>
              ...
              <View style={styles.view3}>
                ...
                />
                <TouchableOpacity style={styles.ggPress} onPress={signinPress}>
                  {/* <Icon name='Google-plus' color='blue' size={verticalScale(30)} /> */}
                  {/* <TouchableOpacity
                                        style={styles.touchableOpacity}
                                        onPress={signinPress}
                                    > */}
                  <TextBase title="Đăng ký ngay?" style={styles.signin} />
                  {/* </TouchableOpacity> */}
                </TouchableOpacity>
              </View>
            </View>

  ...
  return (
    <View
      style={[
        ...
        {borderBottomWidth: 1, borderBottomColor: colors.inputBorderColor},
        safeAreaViewStyle,
      ]}
    >
      <StatusBar
      ...
      <SafeAreaView
        style={[
          styles.container,
          DeviceInfo.isTablet() ? {alignItems: 'center'} : {},
        ]}
      >
        {iconLeft ? (
          <TouchableOpacity
          ...
          >
            <Icon
              ...
              color={iconLeftColor ? iconLeftColor : 'black'}
              style={iconLeftStyle}
            />
          </TouchableOpacity>
        ) : null}
...
const styles = StyleSheet.create({
  container: {
    ...
    height:
      Platform.OS == 'android'
        ? verticalScale(60) + verticalScale(StatusBar.currentHeight)
        : DEVICE_HEIGHT > 780
        ? verticalScale(80)
        : verticalScale(60),
  },
  safeAreaViewStyle: {
    paddingTop:
      Platform.OS == 'android'
        ? verticalScale(StatusBar.currentHeight) + verticalScale(15)
        : 0,
    height:
      Platform.OS == 'android'
        ? verticalScale(60) + verticalScale(StatusBar.currentHeight)
